  ...
  useEffect(() => {
    ...
    ajax(`/api/assignments/${assignmentId}`, "GET", user.jwt).then(
      (assignmentResponse) => {
        ...
        console.log("assignmentEnums " + JSON.stringify(assignmentResponse.assignmentEnums));
        console.log("assignmentResponse.statusEnums " + JSON.stringify(assignmentResponse.statusEnums));
